...
3. Configure the jenkins job with `Source Code Management`:`Git` and configure it with this our `guestbook` repo : `https://github.com/akhilrajmailbox/GuestBook.git`
