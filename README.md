...
3. Configure the jenkins job with `Source Code Management`:`Git` {Branch : master} and configure it with this our `guestbook` repo : `https://github.com/akhilrajmailbox/GuestBook.git`
